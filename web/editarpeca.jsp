  ...
  <body>
      ...
      <div class="container">
          <div class="row">
              <blockquote class="col-md-12 text-center"> 
                  ...
                  <a type="button" class="btn btn-default" href="pecas.jsp">VOLTAR</a>
              </blockquote>
          </div>
      </div>
    </div><br><br>
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                 <form class="form-horizontal" action="form_submit/peca_edit.jsp" method="post">  
                <div class="col-md-8 center-block">
                  <div class="form-group">
                    <label  class="col-sm-2 control-label">Tipo</label>
                    <div class="col-sm-10">
                        <input type="hidden" value="${param.id}" name="id"/>
                        <input type="text" class="form-control" name="type" value="${row.pec_type}" autofocus required>
                    </div>
                  </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Marca</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="mark" value="${row.pec_mark}" required>
                        </div>
                      </div>
                  <div class="form-group">
                    <label  class="col-sm-2 control-label">Descrição</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="details" value="${row.pec_details}" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label  class="col-sm-2 control-label">Referência</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="reference" value="${row.pec_reference}" pattern="[0-9]{6}" title="Referência deve conter 6 dígitos numéricos" required>
                    </div>
                  </div>
                     <div class="form-group">
