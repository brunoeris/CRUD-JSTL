<%-- 
    Document   : clientes
    Created on : 13/01/2015, 00:32:36
    Author     : fromd_000
--%>
      ...
      <div class="container">
          <div class="row">
              <blockquote class="col-md-12"> 
                  <h2>Clientes<br><small>Gerencie os clientes da sua loja.</small></h2>
                          ...
                          <tbody>
                            ...
                            <c:forEach var="row" items="${result.rows}">  
                                <tr>
                                    ...
                                    <td><button type="button" onclick="atualizarCliente(<c:out value="${row.id}"/>);" class="btn btn-warning pull-right"><i class="fa fa-pencil"></i></button></td>
                                    <td><button type="button" onclick="excluirCliente(<c:out value="${row.id}"/>);" class="btn btn-danger pull-right"><i class="fa fa-trash-o"></i></button></td>
                                </tr>
                            </c:forEach>
                          </tbody>
                        </table>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">          
          <form class="form-horizontal" action="actions/cadastrarcliente.jsp" method="post">  
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="email" class="form-control" name="email" placeholder="Digite o email do Cliente">
                    </div>
                  </div>
                  <div class="form-group">
                    <label  class="col-sm-2 control-label">Telefone</label>
                    <div class="col-sm-10">
                      <input type="number" class="form-control" name="telefone" placeholder="Digite o telefone do Cliente">
                    </div>
                  </div>
                    <div class="form-group">
